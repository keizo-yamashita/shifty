...
const List<String> templateRequestLimitSelect  = ["シフト開始 7 日前", "シフト開始 6 日前", "シフト開始 5 日前", "シフト開始 4 日前", "シフト開始 3 日前", "シフト開始 2 日前"];
...
class ShiftFrame{
  ...
  ShiftFrame([
    ...
    this.shiftDateRange = shiftDateRange ?? [
      ...
      DateTimeRange(start: DateTime.now(), end: DateTime(DateTime.now().year, DateTime.now().month + 1, 0))
    ];
