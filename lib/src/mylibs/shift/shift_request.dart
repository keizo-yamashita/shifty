              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding: const EdgeInsets.all(20.0),
                      child: Text(title, style: (DateTime.now().compareTo(shiftFrame.shiftDateRange[0].end) <= 0) ? MyStyle.headlineStyleGreen15 : MyStyle.defaultStyleGrey15, textHeightBehavior: MyStyle.defaultBehavior, textAlign: TextAlign.center, overflow: TextOverflow.ellipsis),
                    ),
                    Text(
