...
class ShiftResponseEditor extends StatelessWidget {
  ...
  List<Widget> _getTitleWidget(){
    ...
    var columnNum = shiftRequest.shiftFrame.shiftDateRange[0].end.difference(shiftRequest.shiftFrame.shiftDateRange[0].start).inDays+1;
  ...
  Widget _cell(int row, int column, bool editable) {
    ...
    if(value == 1){ 
      cellValue = Icon((shiftRequest.responseTable[row][column] == 1) ? Icons.circle : Icons.circle_outlined, size: 12 * cellWidth / 20, color: MyStyle.primaryColor);
