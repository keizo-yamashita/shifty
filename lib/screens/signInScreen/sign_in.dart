...
class SignInScreenState extends ConsumerState<SignInScreen> {
          ...
          child: Center(
            child: Column(
              ...
              children: <Widget>[
                ...
                const SizedBox(height: 10),
                signInButton(context, ref, "guest", "assets/person2.png",
                    "ゲストログイン", Colors.tealAccent, Styles.defaultStyleBlack18),
              ],
            ),
          ),
        ),
  ...
  Widget signInButton(BuildContext context, WidgetRef ref, String providerName,
      String imageUri, String buttonTitle, Color baseColor, TextStyle textStyle,
      [double? width, String? mail, String? password]) {
    return SizedBox(
      height: 50,
