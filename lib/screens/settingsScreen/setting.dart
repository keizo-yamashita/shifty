                    ...
                    showConfirmDialog(
                      ...
                      onAccept: () {
                        ref.read(signInProvider).deleteUserData().then(
                          (value) {
                            ref.read(signInProvider).deleteUser().then((error) {
                              if (error) {
                                showAlertDialog(
                                  context,
                                  ref,
...
class DrawerHelper {
  ...
  static const String _urlAppStore =
      'https://apps.apple.com/jp/app/shifty-%E3%82%B7%E3%83%95%E3%83%88%E8%A1%A8%E4%BD%9C%E6%88%90%E3%82%A2%E3%83%97%E3%83%AA/id6458593130';
  static const String _urlPlayStore =
      'https://play.google.com/store/apps/details?id=com.kakupan.shift&pcampaignid=web_share';
